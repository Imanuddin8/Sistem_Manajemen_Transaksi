                            ...
                            <form id="form" action="{{ route('pembelian.update', $pembelian->id) }}" method="post"
                                ...
                                >
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <input value="{{$pembelian->jumlah}}" name="jumlah" id="jumlah" class="form-control" id="exampleFormControlInput1" placeholder="Jumlah produk" required type="number" oninvalid="this.setCustomValidity('Jumlah harus lebih dari 1')"
